...
@Component({
    selector: 'stl-garv-frontend-amar-chitra-katha',
    templateUrl: './amar-chitra-katha.component.html',
    styles: []
})
export class AmarChitraKathaComponent implements OnInit , OnDestroy {
