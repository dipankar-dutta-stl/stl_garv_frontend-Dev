...
@Component({
    selector: 'stl-garv-frontend-stl-garv-content',
    templateUrl: './stl-garv-content.component.html',
    styles: []
})
export class StlGarvContentComponent implements OnInit , OnDestroy {
