    ...
    editProduct(product_id: number){
        ...
        if(product_id){
            ...
            this.eportalService.getProductDetailsById(product_id).pipe(takeUntil(this.endSubs$)).subscribe(
                ...
                {
                    console.log(data)
                    this.createProductForm.product_title.setValue(data?.product_title);
                    this.createProductForm.f_manufacturers.setValue(data?.manufacturer_id);
                    this.createProductForm.f_categories.setValue(data?.p_cat_id);
                    this.createProductForm.product_price.setValue(data?.product_price);
                    this.createProductForm.product_psp_price.setValue(data?.product_psp_price);
                    this.createProductForm.product_desc.setValue(data?.product_desc);
                    this.createProductForm.product_features.setValue(data?.product_features);
                    this.createProductForm.product_video.setValue(data?.product_video);
