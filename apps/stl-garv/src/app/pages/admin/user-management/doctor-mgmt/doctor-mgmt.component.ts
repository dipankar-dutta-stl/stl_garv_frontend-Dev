...
@Component({
    selector: 'stl-garv-frontend-doctor-mgmt',
    templateUrl: './doctor-mgmt.component.html',
    styles: []
})
export class DoctorMgmtComponent implements OnInit , OnDestroy {
