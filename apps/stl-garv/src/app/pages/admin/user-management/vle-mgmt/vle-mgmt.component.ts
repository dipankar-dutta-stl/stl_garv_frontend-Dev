...
@Component({
    selector: 'stl-garv-frontend-vle-mgmt',
    templateUrl: './vle-mgmt.component.html',
    styles: []
})
export class VleMgmtComponent implements OnInit , OnDestroy {
