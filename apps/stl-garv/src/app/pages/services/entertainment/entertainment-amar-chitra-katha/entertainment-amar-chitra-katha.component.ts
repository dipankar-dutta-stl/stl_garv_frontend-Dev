...
@Component({
    selector: 'stl-garv-frontend-entertainment-amar-chitra-katha',
    templateUrl: './entertainment-amar-chitra-katha.component.html'
})
export class EntertainmentAmarChitraKathaComponent implements OnInit, OnDestroy {
    ...
    private _getAudioContent() {
        ...
        for (let _i=0,j=0; _i<this.mediaContents.length; _i++){
            if(this.mediaContents[_i].media_type == "Audio" && this.mediaContents[_i].source == "Amar_Chitra_Katha") {
    ...
    private _getPdfContent() {
        this.mediaType='PDF';
        for (let _i=0,j=0; _i<this.mediaContents.length; _i++){
            if(this.mediaContents[_i].media_type == "PDF" && this.mediaContents[_i].source == "Amar_Chitra_Katha") {
    ...
    private _getVideoContent() {
        ...
        for (let _i=0,j=0; _i<this.mediaContents.length; _i++){
            if(this.mediaContents[_i].media_type =="Video" && this.mediaContents[_i].source == "Amar_Chitra_Katha") {
    ...
    private _categoryFilter(medtype:string, cat_name:string){
        ...
        this.mediacontentService.filterMediaByCategory(body).subscribe(response =>{
