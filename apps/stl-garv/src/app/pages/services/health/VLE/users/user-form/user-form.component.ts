...
@Component({
    selector: 'stl-garv-frontend-user-form',
...
export class UserFormComponent implements OnInit, OnDestroy {
        ...
        this.route.params.subscribe((params) => {
            if(params.id) {
                ...
                this.userService.getUserDetailbyuid(this.userId).pipe(takeUntil(this.endSubs$)).subscribe((userDetail) => {
                    ...
                    this.isGPChanged=userDetail[0].details[0].isGPChanged;
                    if (this.isGPChanged == 1){
                        console.log(this.isGPChanged);
                        this.isDisabled = true;
                    }
                    if(this.isGPChanged == 0){
                        console.log(this.isGPChanged);
    ...
    //         this.createUserForm.state_id.setValue(res[0].details[0].state_id);
    //         this.createUserForm.district_id.setValue(res[0].details[0].district_id);
    //         this.createUserForm.taluka_id.setValue(res[0].details[0].taluka_id);
    //         this.createUserForm.village_id.setValue(res[0].details[0].village_id);
    //         this.createUserForm.panchayatfield.setValue(this.panchayatId);   
    //     })
    // }
