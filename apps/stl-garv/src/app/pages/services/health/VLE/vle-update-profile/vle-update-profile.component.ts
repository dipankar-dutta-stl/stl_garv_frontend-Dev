...
@Component({
    selector: 'stl-garv-frontend-vle-update-profile',
    templateUrl: './vle-update-profile.component.html',
    styles: []
})
export class VleUpdateProfileComponent implements OnInit, OnDestroy {
    ...
    private _initForm() {
        this.form = this.formBuilder.group({
            ...
            middle_name: [''],
            last_name: [''],
            unique_id: [{value:'', disabled: true}, Validators.required, ],
            ...
            address: [''],
            image: ['']
            // imageDisplay: ['', Validators.pattern('[^\\s]+(.*?)\\.(jpg|jpeg|png|gif|JPG|JPEG|PNG|GIF)$')]
        })
    }
