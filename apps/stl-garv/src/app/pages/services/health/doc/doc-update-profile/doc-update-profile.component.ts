...
@Component({
    selector: 'stl-garv-frontend-doc-update-profile',
    templateUrl: './doc-update-profile.component.html',
    styles: []
})
export class DocUpdateProfileComponent implements OnInit,OnDestroy {
